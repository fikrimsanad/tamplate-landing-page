...
export default function SectionWhy() {
  return (
    <div className='mb-36'>
        <div className='sm:flex-1 py-10 px-4 text-center'>
            <h1 className="text-Loyal-Blue text-4xl font-bold">Kenapa <span className='text-Loyal-Green'>Belajar</span> Disini ?</h1>
            <p className='text-base mx-auto sm:w-2/4 mt-6 mb-6 text-gray-400'>Kalian bisa belajar secara keseluruhan mulai dari yang Basic hingga advance. Waktu belajar yang flexibel dan materi pembelajaran sesuai dengan case dilapangan</p>
        </div>
        <div className='mx-auto sm:flex justify-center mt-10'>
            <div className='mt-5'>
